...
const ScheduleCalendar: React.FC = () => {
  ...
  const handleDateClick = (date: Date) => {
    ...
    setExpandedSlots(new Set()); // 날짜 변경시 모든 슬롯 접기
  };
  ...
  // 예약 등록 모달 열기
  const openBookingModal = (time: string, dateStr: string) => {
          ...
          >
            ...
            <div style={{
              ...
              {generateTimeSlots().map((timeSlot) => {
                const schedulesAtTime = getSchedulesForDate(selectedDate).filter(
                  s => s.schedule_time === timeSlot
                );
                const isExpanded = expandedSlots.has(timeSlot);
                const hasSchedules = schedulesAtTime.length > 0;
                ...
                return (
                  <div key={timeSlot}>
                    {/* 시간대 헤더 카드 */}
                    <div onClick={() => toggleSlot(timeSlot)} style={{ cursor: 'pointer' }}>
                      <Card style={{
                        ...
                        <div style={{
                          ...
                          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                            ...
                            <div style={{
                              ...
                              {schedulesAtTime.length} / {bookingCapacity}
                            </div>
                          </div>
                          <div style={{
                            fontSize: '24px',
                    ...
                    {isExpanded && (
                      <div style={{
                        ...
                        {Array.from({ length: bookingCapacity }, (_, index) => {
                          ...
                          const teamSchedule = schedulesAtTime[index];
                              ...
                              <div style={{ padding: '12px' }}>
                                ...
                                {teamSchedule ? (
                                  ...
                                  <div
                                    onClick={(e) => {
                                      e?.stopPropagation();
                                      openBookingModal(timeSlot, dateStr);
                                    }}
                                    style={{
                                      padding: '24px',
                                      textAlign: 'center',
      ...
      {isBookingModalOpen && (
        <div style={{
          ...
          <div style={{
            ...
            {/* 폼 영역 - 스크롤 가능 */}
            <form onSubmit={handleBookingSubmit} style={{ display: 'flex', flexDirection: 'column', flex: 1, overflow: 'hidden' }}>
              <div style={{
                padding: '24px',
                overflowY: 'auto',
                flex: 1,
              ...
              <div style={{
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  ...
                  <Button type="button" variant="secondary" onClick={closeBookingModal}>
                    취소
                  </Button>
                </div>
              </div>
